...
interface ChatApi {
    ...
    @GET
    suspend fun listMyApprovalCases(
        @Url url: String,
...
data class ChatPushDiagnosticsDto(
    val enabled: Boolean?,
    ...
    val currentRegistration: ChatPushRegistrationDto?,
...
data class ChatPushRegistrationDto(
    val status: String?,
...
data class ChatPushTestResultDto(
